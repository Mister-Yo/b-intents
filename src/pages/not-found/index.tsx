...
const NotFoundPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>404 - Page Not Found | NEAR Intents</title>
      ...
      <div className="fixed inset-0 flex flex-col items-center justify-center gap-6 bg-[#0a0a0a] px-4">
          ...
          >
            <defs>
              <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <stop offset="30%" stopColor="#F05A28" stopOpacity="0.6" />
                <stop offset="60%" stopColor="#F05A28" stopOpacity="0.2" />
        ...
        <p className="text-sm text-white/30">
          ...
          <a href="/" className="text-[#F05A28]/60 transition-colors hover:text-[#F05A28]">
            Go back
          </a>
        </p>
      </div>
